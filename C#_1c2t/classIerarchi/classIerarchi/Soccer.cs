...
{
	class Soccer : Sportsman, InterfaceDifferentSports
	{
		public const String sport = "Soccer";
		public Soccer(String sex = Man.SEX_UNKNOWN, float age = Man.VAR_UNINIT, float hight = Man.VAR_UNINIT, float weight = Man.VAR_UNINIT, float carrerDuration = Man.VAR_UNINIT):base( sex, age, hight, weight, carrerDuration )
		{

		}
		public override void showInfo()
		{
			Console.Write("\tInfo about Soccer's object\n");
