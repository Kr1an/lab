...
{
	class Fighter : Sportsman, InterfaceDifferentSports
	{
		public const String sport = "Fight";
		public Fighter(String sex = Man.SEX_UNKNOWN, float age = Man.VAR_UNINIT, float hight = Man.VAR_UNINIT, float weight = Man.VAR_UNINIT, float carrerDuration = Man.VAR_UNINIT):base( sex, age, hight, weight, carrerDuration )
		{
			CarrerDuration = carrerDuration;
		}
		public override void showInfo()
		{
			Console.Write("\tInfo about Fighter's object\n");
